...
# Side Panel
st.sidebar.header("Please choose inputs")
selected_year =  st.sidebar.selectbox("Year", list(reversed(range(1990, 2023))))

# Web Scraping of NFL Players Stats
# https://www.pro-football-reference.com/years/2022/rushing.html
...
sorted_inique_team = sorted(playerstats.Tm.unique())
selected_team = st.sidebar.multiselect("Team", sorted_inique_team, sorted_inique_team)
...
# Download NBS player stats data
def filedownload(df):
